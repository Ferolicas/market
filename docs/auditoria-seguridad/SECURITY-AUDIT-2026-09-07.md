...
| SEC-04 | Medio | Caddy entrega HSTS por un año, CSP compatible con la aplicación 3D web, `X-Frame-Options: DENY`, nosniff, referrer, permissions, COOP y COEP. La PWA arrancó bajo estas cabeceras sin fallos de CSP. | Corregido |
...
- La revisión vigente se publica como aplicación Next.js/Three.js bajo PM2 y
  se valida con la batería de pruebas descrita arriba.
