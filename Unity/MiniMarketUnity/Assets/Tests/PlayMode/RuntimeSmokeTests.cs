...
namespace MiniMarket.PlayModeTests
{
    public sealed class RuntimeSmokeTests
    {
        ...
        {
            var playerObject=new GameObject("SingleEntryPlayer");var body=playerObject.AddComponent<CharacterController>();
            ...
            body.enabled=false;playerObject.transform.position=Vector3.right*10f;body.enabled=true;yield return null;
            body.enabled=false;playerObject.transform.position=Vector3.zero;body.enabled=true;yield return null;yield return null;
