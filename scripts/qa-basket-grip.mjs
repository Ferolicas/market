...
// The basket is centred on the body axis and level; each palm may sit up to
// half a hand along the bar from its grip sphere while the hands sway.
if (maxPalmGap > 0.12) throw new Error(`La canasta no toca ambas palmas: ${maxPalmGap}`);
