...
} else if (renderProfile.targetFps !== 30 || renderProfile.motionFps !== 60 || renderProfile.dpr !== 2 || renderProfile.antialias !== true || renderProfile.transmissionResolutionScale !== 0.5 || renderProfile.powerPreference !== "low-power") throw new Error(`Perfil móvil equilibrado incorrecto: ${JSON.stringify(renderProfile)}`);
